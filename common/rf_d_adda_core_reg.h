...
#define RF_D_ADDA_CORE_REG_BASE                   (0x0)
...
#define RG_CORE_A9                                (RF_D_ADDA_CORE_REG_BASE + 0x24)
// Bit 4   :0      rg_testbus_sel                 U     RW        default = 'h0
typedef union RG_CORE_A9_FIELD
{
  unsigned int data;
  struct
  {
    unsigned int rg_testbus_sel : 5;
    unsigned int rsvd_0 : 27;
  } b;
} RG_CORE_A9_FIELD_T;

#define RG_CORE_A10                               (RF_D_ADDA_CORE_REG_BASE + 0x28)
