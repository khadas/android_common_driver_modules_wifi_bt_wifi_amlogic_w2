...
// Bit 31  :16     rg_dev_reset_hw                U     RW        default = 'h7
...
#define RG_PMU_A29                                (CHIP_PMU_REG_BASE + 0x74)
// Bit 30  :0      ro_pmu_cnt                     U     RO        default = 'h0
typedef union RG_PMU_A29_FIELD
{
  unsigned int data;
  struct
  {
...
#define RG_PMU_A30                                (CHIP_PMU_REG_BASE + 0x78)
// Bit 3   :0      ro_pmu_curr_st                 U     RO        default = 'h0
typedef union RG_PMU_A30_FIELD
{
  unsigned int data;
  struct
  {
