...
#define RG_MAC_LOCAL_ADDRL1 (WIFI_MAC+0x24)
#define RG_MAC_LOCAL_ADDRH1 (WIFI_MAC+0x28)

#define RG_MAC_BSSID0LO_REG (WIFI_MAC+0x3c)
#define RG_MAC_BSSID0HI_REG (WIFI_MAC+0x40)
#define RG_MAC_BSSID1LO_REG (WIFI_MAC+0x44)
#define RG_MAC_BSSID1HI_REG (WIFI_MAC+0x48)

#define RG_MAC_COUNT2 (WIFI_MAC+0Xb4)
#define RG_MAC_CHANNEL_INDEX (WIFI_MAC+0X1e0)
#define RG_MAC_BSSIDLO_N(_vid) ((_vid)?(RG_MAC_BSSID1LO_REG+((_vid)-1)*8):RG_MAC_BSSID0LO_REG)
#define RG_MAC_BSSIDHI_N(_vid) ((_vid)?(RG_MAC_BSSID1HI_REG+((_vid)-1)*8):RG_MAC_BSSID0HI_REG)
#define RG_MAC_LOCAL_ADDRLN(_vid) ((_vid)?(RG_MAC_LOCAL_ADDRL1+((_vid)-1)*8):RG_MAC_LOCAL_ADDRL0)
#define RG_MAC_LOCAL_ADDRHN(_vid) ((_vid)?(RG_MAC_LOCAL_ADDRH1+((_vid)-1)*8):RG_MAC_LOCAL_ADDRH0)
