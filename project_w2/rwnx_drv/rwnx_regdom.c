...
const struct rwnx_regdom rwnx_regdom_00 = {
    .country_code = "00",
    .regdom = &regdom_global
};

const struct rwnx_regdom rwnx_regdom_cn = {
    .country_code = "CN",
    .regdom = &regdom_cn
};

const struct rwnx_regdom rwnx_regdom_us = {
    .country_code = "US",
    .regdom = &regdom_us
};

const struct rwnx_regdom rwnx_regdom_jp = {
    .country_code = "JP",
    .regdom = &regdom_jp
};

const struct rwnx_regdom *rwnx_regdom_tbl[] = {
    &rwnx_regdom_00,
    &rwnx_regdom_cn,
    &rwnx_regdom_us,
    &rwnx_regdom_jp,
...
const struct ieee80211_regdomain *rwnx_get_regdom(char *alpha2)
{
    const struct rwnx_regdom *regdom;
    int i = 0;

    while (rwnx_regdom_tbl[i]) {
        regdom = rwnx_regdom_tbl[i];
