...
TRACE_EVENT(
    txq_drop_skb,
    TP_PROTO(struct sk_buff *skb, struct rwnx_txq *txq, unsigned long queued_time),
...
TRACE_EVENT(
    skb_retry,
    TP_PROTO(struct sk_buff *skb, struct rwnx_txq *txq, uint16_t sn),
...
TRACE_EVENT(
    amsdu_len_update,
    TP_PROTO(struct rwnx_sta *sta, int amsdu_len),
