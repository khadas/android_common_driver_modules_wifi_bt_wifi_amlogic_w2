 ...
 * HW type
 ******************************************************************************/
#define RWNX_MACHW_NX 1
#define RWNX_MACHW_HE 2
...
extern const struct rwnx_legrate legrates_lut[];
...
void rwnx_rx_vector_convert(int machw_type, struct rx_vector_1 *rx_vect1,
                            struct rx_vector_2 *rx_vect2);
