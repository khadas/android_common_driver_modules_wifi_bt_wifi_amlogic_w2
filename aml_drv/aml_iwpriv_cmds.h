...
#endif
    AML_IWP_USB_TRACE_ENABLE = 111,
    AML_IWP_SET_EFUSE_VENDOR_SN = 112,
    AML_IWP_GET_EFUSE_VENDOR_SN = 113,
    AML_IWP_SET_PUTV_TRACE_SWITCH = 114,
    AML_IWP_SET_DEAYL_ACK_RSSI_THR = 115,
    AML_IWP_ENABLE_RSSI_REG = 116,
    AML_IWP_GET_BCN_RSSI = 117,
    AML_COEX_GET_STATUS = 118,
    AML_IWP_SET_TCP_ACK_WINDOW_SCALE = 119,
};
