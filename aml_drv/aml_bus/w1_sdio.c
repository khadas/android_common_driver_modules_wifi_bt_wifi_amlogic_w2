...
extern unsigned int  shutdown_i;
extern unsigned char wifi_sdio_shutdown;
extern void* wlan_static_hw_rx_buf;
extern void* wlan_static_sdio_buf;
extern  void* wlan_static_amsdu_buf;
extern void* wlan_static_aml_buf_type_txq;
extern void* wlan_static_aml_buf_type_dump;
extern void* wlan_static_download_fw;
...
static int amlw_w1_sdio_alloc_prep_scat_req(struct aml_hwif_sdio *hif_sdio)
{
    struct amlw_hif_scatter_req * scat_req = NULL;
...
int aml_w1_sdio_enable_scatter(void)
{
    ...
    ret = amlw_w1_sdio_alloc_prep_scat_req(&g_hwif_sdio);
    return ret;
}
...
int aml_w1_init_wlan_mem(void)
{
    unsigned long size = 0;
    PRINT("%s\n", AML_STATIC_VERSION_STR);

    wlan_static_dhd_memdump_ram_buf = wlan_static_aml_buf_type_dump;
    ...
    wlan_static_fw_verbose_ring_buf = wlan_static_download_fw;
...
#endif
void aml_w1_deinit_wlan_mem(void)
{
    kfree(wlan_static_amsdu_buf);
    kfree(wlan_static_sdio_buf);
    kfree(wlan_static_hw_rx_buf);
